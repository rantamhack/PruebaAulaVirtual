...
import { BrainCircuit, Clock, Target, User, BookOpen, ChevronDown, Sparkles, FlaskConical } from 'lucide-react';
...
const CourseForm: React.FC<Props> = ({ onSubmit, onLoadDemo, isLoading }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-8 relative z-10">
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-8 space-y-6 relative overflow-hidden backdrop-blur-sm bg-opacity-90 dark:bg-opacity-90">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Nivel Actual</label>
            <div className="relative">
                <select
          ...
          {/* Format - CRITICAL */}
          <div className="space-y-2">
            <label className="block text-sm font-bold text-electric-600 dark:text-electric-400">Formato Preferido</label>
            <div className="relative">
                <select
                ...
                >
                  {Object.values(CourseFormat).map(f => <option key={f} value={f}>{f}</option>)}
                </select>
          ...
          {/* Profile */}
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Tu Perfil</label>
            <div className="relative">
          ...
          {/* Time */}
          <div className="md:col-span-2 space-y-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Tiempo Disponible</label>
            <div className="relative">
